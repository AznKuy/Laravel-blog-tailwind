...
@section('conten')
    <div class="max-w-xl py-6 px-8 h-90 mt-20 bg-white rounded shadow-md shadow-purple-800 mx-auto">
        ...
        <form action="/login/action" method="post">
            @csrf
            {{-- INI test --}}
            <h2 class="text-xl font-bold text-gray-800 text-center">Login Form</h2>
            <div class="mb-4">
            ...
            <a href="/register"
                class="text-sm text-semibold font-thin text-blue-600 hover:underline mt-2 inline-block hover:text-indigo-600">Register</a>
        </form>
    </div>
@endsection
